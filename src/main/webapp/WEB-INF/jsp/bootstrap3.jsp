...
<span class="nt">&lt;/label&gt;</span></code></pre></figure>
  ...
  <h4>不带label文本的Checkbox 和 radio</h4>
...
<figure class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="k">@brand-primary</span><span class="nd">:</span> <span class="nt">darken</span><span class="o">(</span><span class="nn">#428bca</span><span class="o">,</span> <span class="nt">6</span><span class="nc">.5</span><span class="nv">%</span><span class="o">)</span><span class="p">;</span> <span class="c1">// #337ab7
...
<figure class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="c1">// Use as-is
...
<figure class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="c1">// Scaffolding
...
<span class="k">@text-color</span><span class="nd">:</span> <span class="o">@</span><span class="nt">black-50</span><span class="p">;</span></code></pre></figure>
  ...
  <h3 id="less-variables-links">链接</h3>
  <p>仅仅通过改变一个变量，可以很容易地为链接赋予正确的颜色。</p>
<figure class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="c1">// Variables
...
<span class="p">}</span></code></pre></figure>
  ...
  <h3 id="less-variables-typography">排版</h3>
...
<span class="k">@headings-color</span><span class="nd">:</span>          <span class="nt">inherit</span><span class="p">;</span></code></pre></figure>
  ...
  <h3 id="less-variables-icons">图标</h3>
...
<span class="k">@caret-width-large</span><span class="nd">:</span>              <span class="nt">5px</span><span class="p">;</span></code></pre></figure>
  ...
  <h2 id="less-mixins-vendor">特定浏览器厂商的 mixin</h2>
...
<span class="p">}</span></code></pre></figure>
  ...
  <h3 id="less-mixins-rounded-corners">圆角</h3>
...
<span class="p">}</span></code></pre></figure>
  ...
  <h3 id="less-mixins-box-shadow">Box (Drop) 隐形</h3>
...
<span class="p">}</span></code></pre></figure>
  ...
  <h3 id="less-mixins-transitions">过渡效果</h3>
...
<span class="p">}</span></code></pre></figure>
  ...
  <h3 id="less-mixins-transformations">变形</h3>
...
<span class="p">}</span></code></pre></figure>
  ...
  <h3 id="less-mixins-animations">动画</h3>
...
<span class="p">}</span></code></pre></figure>
  ...
  <h3 id="less-mixins-opacity">透明度</h3>
...
<span class="p">}</span></code></pre></figure>
  ...
  <h3 id="less-mixins-placeholder">占位符文本</h3>
...
<figure class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="err">.</span><span class="na">placeholder</span><span class="err">(@</span><span class="nl">color</span><span class="p">:</span> <span class="o">@</span><span class="n">input-color-placeholder</span><span class="p">)</span> <span class="p">{</span>
  ...
  <h3 id="less-mixins-columns">列</h3>
...
<span class="p">}</span></code></pre></figure>
  ...
  <h3 id="less-mixins-gradients">渐变</h3>
...
<span class="nn">#gradient</span> <span class="o">&gt;</span> <span class="nc">.horizontal-three-colors</span><span class="o">(</span><span class="nn">#777</span><span class="p">;</span> <span class="nn">#333</span><span class="p">;</span> <span class="nt">25</span><span class="nv">%</span><span class="p">;</span> <span class="nn">#000</span><span class="o">)</span><span class="p">;</span></code></pre></figure>
  ...
  <h2 id="less-mixins-utility">实用工具 mixin</h2>
  <p>实用工具 mixin 用于与不相关的 CSS 结合以达到特定目的或任务。</p>

  <h3 id="less-mixins-clearfix">Clearfix -- 清除浮动</h3>
...
<span class="p">}</span></code></pre></figure>
  ...
  <h3 id="less-mixins-centering">水平居中</h3>
...
<span class="p">}</span></code></pre></figure>
  ...
  <h3 id="less-mixins-sizing">尺寸助手 mixin</h3>
  <p>用于方便的指定对象的尺寸。</p>
<figure class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="c1">// Mixins
...
<span class="nc">.avatar</span> <span class="p">{</span> <span class="nc">.square</span><span class="o">(</span><span class="nt">48px</span><span class="o">)</span><span class="p">;</span> <span class="p">}</span></code></pre></figure>
  ...
  <h3 id="less-mixins-resizable">可调整大小的文本域</h3>
...
<span class="p">}</span></code></pre></figure>
  ...
  <h3 id="less-mixins-truncating">截断文本</h3>
...
<span class="p">}</span></code></pre></figure>
  ...
  <h3 id="less-mixins-retina-images">视网膜屏幕（Retina）下的图片</h3>
